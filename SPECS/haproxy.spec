...
Source0: http://haproxy.1wt.eu/download/1.5/src/devel/%{tarbasename}.tar.gz
Patch100: haproxy.Makefile.patch
...
%build
PKG_CONFIG_PATH=%{extra_pkg_config_path}:$PKG_CONFIG_PATH \
PCREDIR=`pkg-config --variable=prefix libpcre` \
%{__make} USE_PCRE=1 USE_OPENSSL=1 DEBUG="" ARCH=%{_target_cpu} TARGET=linux26
...
%changelog
* Wed Jan 16 2013 Hiroaki Nakamura <hnakamur@gmail.com> 1.5-dev17-2
- updated to link with pcre 8.32 and openssl 1.0.1c
