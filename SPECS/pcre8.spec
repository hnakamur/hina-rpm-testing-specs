...
echo %{_libdir} > $RPM_BUILD_ROOT/etc/ld.so.conf.d/pcre-%{version}.conf
...
%files
%defattr(-,root,root)
%{_sysconfdir}/ld.so.conf.d/pcre-%{version}.conf
%{_libdir}/*.so.*
%{_mandir}/man1/*
%{_bindir}/pcregrep
%{_bindir}/pcretest
...
%changelog
* Tue Dec 26 2012 Hiroaki Nakamura <hnakamur@gmail.com> - 8.32-1
